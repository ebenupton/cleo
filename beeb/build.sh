...
ca65 -g --cpu 65C02 ${MODE1:+-D MODE1=1} ${DBGHIT:+-D DBGHIT=1} ${DBGTILE:+-D DBGTILE=1} ${DBGSND:+-D DBGSND=1} ${VISROWSDEF:+-D VISROWSDEF=$VISROWSDEF} -I src -I build -o build/main.o src/main.s -l build/main.lst
