...
DATA="SPR:build/SPR:8000 TILES0:build/TILES0:3000 TILES1:build/TILES1:3000 SPRAND:build/SPRAND:8000 BOX:build/BOX:B000 MUSIC:build/MUSIC:B800 ALT:build/ALT:AD00 TITLE:build/TITLE:8000"
...
DATA="$DATA TABLES:build/TABLES:0400 TILES2:build/TILES2:3000 LOGIC:build/LOGIC:8900"
