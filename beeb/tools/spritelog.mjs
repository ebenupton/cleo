...
{ let ok = false; for (let a = A.level_loop; a < A.level_loop + 16; a++) if (rd(a) === 0xa6 && rd(a + 1) === (A.level & 255)) { wr(a, 0xa2); wr(a + 1, 0x02); ok = true; break; } if (!ok) throw new Error("ldx level not found"); }   // ldx level sits after jsr blank_palette
